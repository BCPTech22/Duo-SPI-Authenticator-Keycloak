...
public class DuoAuthenticatorFactory implements org.keycloak.authentication.AuthenticatorFactory {
    public static final String PROVIDER_ID = "bcp-duo-keycloak";
    ...
    public String getHelpText() {
        return "Uses the Duo webservice to provide 2FA services.";
    }
    ...
    public Authenticator create(KeycloakSession keycloakSession) {
        return DuoAuthenticator.SINGLETON;
    }
